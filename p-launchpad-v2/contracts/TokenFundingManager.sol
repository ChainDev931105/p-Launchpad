...
contract TokenFundingManager is AccessControl, Pausable {
    ...
    function initializeTokenFunding(
        ...
        ISPOracle(newPriceOracle).initialize(
        ...
        ProjectInfo(newProjectInfo).initialize(
            newStakeToken,
            newScopeToken,
            newInsurance,
            newPriceOracle,
        ...
        _tokenFundings[_tokenFundingIds.current()] = TokenFunding({
            ...
            projectInfoAddress: newProjectInfo
        });
    ...
    /**
     * @notice getter for tokenFundings addresses
     * @param _tokenFundingId the id of the tokenFunding to get
     */
    function getTokenFundingAddresses(uint256 _tokenFundingId)
        public
        view
        returns (
        ...
        )
    {
        ...
        appTokenAddress = _tokenFundings[_tokenFundingId].appTokenAddress;
        insuranceAddress = _tokenFundings[_tokenFundingId].insuranceAddress;
        stakeTokenAddress = _tokenFundings[_tokenFundingId].stakeTokenAddress;
        scopeTokenAddress = _tokenFundings[_tokenFundingId].scopeTokenAddress;
        priceOracleAddress = _tokenFundings[_tokenFundingId].priceOracleAddress;
        projectInfoAddress = _tokenFundings[_tokenFundingId].projectInfoAddress;
    }
}
